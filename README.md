...
During my time at MCAE systems, s.r.o., I was given the task of designing the existing spoiler design, which, among other things, did not include the brake light. Modern 3D technologies such as 3D scanning, reverse engineering and 3D printing were widely used during this project.
